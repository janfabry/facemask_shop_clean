...
OSCAR_INITIAL_ORDER_STATUS = OSCAR_ORDER_STATUSES.PENDING
OSCAR_ORDER_STATUS_PIPELINE = {
    OSCAR_ORDER_STATUSES.PENDING: (
        OSCAR_ORDER_STATUSES.PAID,
        OSCAR_ORDER_STATUSES.CANCELLED,
    ),
    OSCAR_ORDER_STATUSES.PAID: (
        OSCAR_ORDER_STATUSES.QA_PASSED,
        OSCAR_ORDER_STATUSES.IN_PRODUCTION,
        OSCAR_ORDER_STATUSES.SHIPPED,
        OSCAR_ORDER_STATUSES.CANCELLED,
    ),
    OSCAR_ORDER_STATUSES.QA_PASSED: (
        OSCAR_ORDER_STATUSES.IN_PRODUCTION,
...
OSCAR_INITIAL_LINE_STATUS = OSCAR_LINE_STATUSES.PENDING
OSCAR_LINE_STATUS_PIPELINE = {
    OSCAR_LINE_STATUSES.PENDING: (
        OSCAR_LINE_STATUSES.QA_NEEDED,
        OSCAR_LINE_STATUSES.CANCELLED,
    ),
    OSCAR_LINE_STATUSES.QA_NEEDED: (
        OSCAR_LINE_STATUSES.QA_PASSED,
        OSCAR_LINE_STATUSES.QA_FAILED,
        OSCAR_LINE_STATUSES.IN_PRODUCTION,
        OSCAR_LINE_STATUSES.SHIPPED,
        OSCAR_LINE_STATUSES.CANCELLED,
    ),
    OSCAR_LINE_STATUSES.QA_PASSED: (
        OSCAR_LINE_STATUSES.IN_PRODUCTION,
...
OSCAR_ORDER_STATUS_CASCADE = {
    OSCAR_ORDER_STATUSES.PAID: OSCAR_LINE_STATUSES.QA_NEEDED,
    OSCAR_ORDER_STATUSES.QA_PASSED: OSCAR_LINE_STATUSES.QA_PASSED,
    OSCAR_ORDER_STATUSES.IN_PRODUCTION: OSCAR_LINE_STATUSES.IN_PRODUCTION,
    OSCAR_ORDER_STATUSES.SHIPPED: OSCAR_LINE_STATUSES.SHIPPED,
    OSCAR_ORDER_STATUSES.CANCELLED: OSCAR_LINE_STATUSES.CANCELLED,
}

OSCAR_MOLLIE_CONFIRMED_STATUSES = [OSCAR_ORDER_STATUSES.PAID]
...
MOLLIE_STATUS_MAPPING = {
    'Paid': OSCAR_ORDER_STATUSES.PAID,
    'Pending': OSCAR_ORDER_STATUSES.PENDING,
    'Open': OSCAR_ORDER_STATUSES.PENDING,
    'Cancelled': OSCAR_ORDER_STATUSES.CANCELLED,
}
